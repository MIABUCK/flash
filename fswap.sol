...
// Blockchain Monster Hunt (BCMH) is the world��s first multi-chain game that runs entirely on the blockchain itself. Inspired by Pok��mon-GO, BCMH allows players to continuously explore brand-new places on the blockchain to hunt and battle monsters.
